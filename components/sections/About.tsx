      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 md:grid-cols-2">
        <Reveal>
          <div className="relative">
            ...
            <div className="absolute -bottom-5 right-3 rounded-card bg-accent px-6 py-4 text-ink shadow-lg">
              <p className="text-4xl font-bold leading-none">+20</p>
              <p className="mt-1 text-sm font-semibold">años de trayectoria</p>
            </div>
          </div>
        </Reveal>
        <Reveal delay={120}>
          ...
          <p className="mt-5 leading-relaxed text-ink/70">
            Con más de 20 años de trayectoria, Viang Solutions and Service se consolida
            como su socio estratégico en el mantenimiento, instalación y embellecimiento
            de espacios residenciales y comerciales, con tratamientos especializados para
            superficies y servicios integrales de limpieza y reparación de excelencia.
          </p>
